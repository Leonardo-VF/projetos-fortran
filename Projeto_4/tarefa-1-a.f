      ...
      real*8 omega, teta, dt, PI, tFinal, E, t, o
      integer i, step

      open(unit = 10, file = "tarefa-1-saida-1.out")
      open(unit = 20, file = "tarefa-1-saida-2.out")
      open(unit = 30, file = "tarefa-1-saida-5.out")
      open(unit = 40, file = "tarefa-1-saida-6.out")
      ...
      do i = 0, step
          ...
          teta = teta + omega_0*dt*sqrt(g/l)
          E = 1.0d0 - cos(teta) + (1.0d0/2.0d0)*omega_0**2.0d0
